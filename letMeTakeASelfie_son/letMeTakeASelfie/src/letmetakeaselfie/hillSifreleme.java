...
public class hillSifreleme {
    ...
    public boolean check(String key, int len)
    {
        ...
        {
            System.out
                    .println("Geçersiz anahtar!!! Determinant 0 olacağından tersi alınamaz.");
            return false;
        }
        else if (d % 2 == 0 || d % 13 == 0)
        {
            System.out
                    .println("Geçersiz anahtar!!! Determinant 26 ile ortak bölene sahip olduğundan tersi alınamaz.");
            return false;
        }
        else
        {
